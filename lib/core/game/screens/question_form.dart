...
import 'package:quiz_app/core/game/screens/quiz_page.dart';
...
class QuestionForm extends StatefulWidget {
  const QuestionForm(
      {Key? key, required this.name, required this.imageUrl, required this.tag})
      : super(key: key);
  final String name;
          ...
          children: [
            Container(
              padding: const EdgeInsets.only(
                  top: kPaddingM, left: kPaddingS, right: kPaddingS),
              child: Row(
                children: [
                  Image.asset(
                    widget.imageUrl,
                ...
                children: [
                  Padding(
                    ...
                    child: Text('Difficulty:',
                        style: kGetQuestionFormHeaderTheme(context)),
                  ),
                  DropdownButton(
                    underline: Container(),
                ...
                : Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        minimumSize: Size(kScreenWidth(context),
                            kScreenHeight(context) * 0.05),
                      ...
                      onPressed: !_isTyping
                          ...
                          : () async {
                              await context
                                  .read<QuestionFormController>()
                                  .submitAndFetchQuestions(context,
                                      formKey: _formKey,
                                      title: widget.name,
